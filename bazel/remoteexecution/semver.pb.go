...
func (*SemVer) Descriptor() ([]byte, []int) {
	return fileDescriptor_semver_8ba2c8479f1f7de5, []int{0}
}
...
func (dst *SemVer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SemVer.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("build/bazel/semver/semver.proto", fileDescriptor_semver_8ba2c8479f1f7de5)
}

var fileDescriptor_semver_8ba2c8479f1f7de5 = []byte{
