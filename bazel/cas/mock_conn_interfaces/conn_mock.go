...
// Source: github.com/twitter/scoot/bazel/cas/conn_interfaces (interfaces: GRPCDialer,ClientConnPtr)

// Package mock_conn_interfaces is a generated GoMock package.
package mock_conn_interfaces

import (
	gomock "github.com/golang/mock/gomock"
	conn_interfaces "github.com/twitter/scoot/bazel/cas/conn_interfaces"
...
func (m *MockGRPCDialer) Dial(arg0 string, arg1 ...grpc.DialOption) (conn_interfaces.ClientConnPtr, error) {
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "Dial", varargs...)
	ret0, _ := ret[0].(conn_interfaces.ClientConnPtr)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
