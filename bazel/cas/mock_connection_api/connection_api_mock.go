...
// Source: github.com/twitter/scoot/bazel/cas/connection-api (interfaces: GRPCDialer,ClientConnPtr)

// Package mock_connection_api is a generated GoMock package.
package mock_connection_api

import (
	gomock "github.com/golang/mock/gomock"
	connection_api "github.com/twitter/scoot/bazel/cas/connection-api"
...
func (m *MockGRPCDialer) Dial(arg0 string, arg1 ...grpc.DialOption) (connection_api.ClientConnPtr, error) {
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "Dial", varargs...)
	ret0, _ := ret[0].(connection_api.ClientConnPtr)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
