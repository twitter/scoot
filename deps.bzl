...
def go_dependencies():
    go_repository(
        ...
        sum = "h1:OrNfo6f2PN8v+anUt3S3dTBPbVhewwDxplov1dq0kQM=",
        version = "v0.0.0-20160616201512-0e9fed1e12ed",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:L2npp793UcOX2cl42AqIHorMaqGbeSZ1muLlXMbNuYA=",
        version = "v1.0.1-0.20180211072722-58cd061d0938",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ySdE97Qt4sgp0aNgER21TASjkjT/TkBu685hYpmOE7A=",
        version = "v0.0.0-20160613154715-cfa5a85e9f0a",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_twitter_groupcache",
        importpath = "github.com/twitter/groupcache",
        sum = "h1:x/asnk07H/3UZATjr3JRBTbgr1Lsnb39asCxEdIJktQ=",
        version = "v0.0.0-20191021194929-8215cbf3be0f",
    )
    go_repository(
