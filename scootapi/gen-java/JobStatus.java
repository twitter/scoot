            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.taskStatus = new HashMap<String,Status>(2*_map26.size);
                String _key27;
                Status _val28;
                for (int _i29 = 0; _i29 < _map26.size; ++_i29)
                {
                  _key27 = iprot.readString();
                  _val28 = Status.findByValue(iprot.readI32());
                  struct.taskStatus.put(_key27, _val28);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.taskData = new HashMap<String,RunStatus>(2*_map30.size);
                String _key31;
                RunStatus _val32;
                for (int _i33 = 0; _i33 < _map30.size; ++_i33)
                {
                  _key31 = iprot.readString();
                  _val32 = new RunStatus();
                  _val32.read(iprot);
                  struct.taskData.put(_key31, _val32);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.taskStatus != null) {
        if (struct.isSetTaskStatus()) {
          oprot.writeFieldBegin(TASK_STATUS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Status> _iter34 : struct.taskStatus.entrySet())
            {
              oprot.writeString(_iter34.getKey());
              oprot.writeI32(_iter34.getValue().getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.taskData != null) {
        if (struct.isSetTaskData()) {
          oprot.writeFieldBegin(TASK_DATA_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, RunStatus> _iter35 : struct.taskData.entrySet())
            {
      ...
      if (struct.isSetTaskStatus()) {
        {
          ...
          for (Map.Entry<String, Status> _iter36 : struct.taskStatus.entrySet())
          {
            oprot.writeString(_iter36.getKey());
            oprot.writeI32(_iter36.getValue().getValue());
          }
        }
      }
      if (struct.isSetTaskData()) {
        {
          ...
          for (Map.Entry<String, RunStatus> _iter37 : struct.taskData.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.taskStatus = new HashMap<String,Status>(2*_map38.size);
          String _key39;
          Status _val40;
          for (int _i41 = 0; _i41 < _map38.size; ++_i41)
          {
            _key39 = iprot.readString();
            _val40 = Status.findByValue(iprot.readI32());
            struct.taskStatus.put(_key39, _val40);
          }
        }
        struct.setTaskStatusIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.taskData = new HashMap<String,RunStatus>(2*_map42.size);
          String _key43;
          RunStatus _val44;
          for (int _i45 = 0; _i45 < _map42.size; ++_i45)
          {
            _key43 = iprot.readString();
            _val44 = new RunStatus();
            _val44.read(iprot);
            struct.taskData.put(_key43, _val44);
          }
        }
        struct.setTaskDataIsSet(true);
      }
