...
func TestEmptyRequestor(t *testing.T) {
	...
	jobsByJobID := map[string]*jobState{}
	jobsByRequestor := map[string][]*jobState{}
	jobsByRequestor[""] = makeJobStateFromClassState(t, "", classState{numRunningTasks: 0, numWaitingTasks: 215, numJobs: 37}, jobsByJobID)
	...
	lbs := NewLoadBasedAlg(DefaultLoadBasedSchedulerClassPcts, DefaultRequestorToClassMap, statsReceiver)
