...
dev-fullbuild: dev-dependencies generate test-unit coverage

ci: clean-data fs_util install recoverytest smoketest integrationtest test-unit coverage clean-data
