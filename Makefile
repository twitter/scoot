...
test:
	...
	sh testCoverage.sh
	go run ./binaries/daemon/main.go --execer_type=os& python ./daemon/protocol/python/tests/run_many.py
	go run ./binaries/daemon/main.go --execer_type=os& python ./daemon/protocol/python/tests/integration.py
	go run ./binaries/daemon/main.go --execer_type=os& python ./daemon/protocol/python/tests/daemon_cli_test.py
