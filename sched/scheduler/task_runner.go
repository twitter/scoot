...
func runTaskAndLog(
	...
	// TODO(dbentley): Update to use a runner.Service instead of a worker.Worker.
	// This will allow us to wait with the proper timeout and also wait for
	// stdoutRef and stderrRef to appear so we can include it in our reply to the user.
