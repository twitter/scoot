...
type TaskDefinition struct {
	...
	BazelRequest *BazelExecuteRequest `thrift:"bazelRequest,3" json:"bazelRequest,omitempty"`
}
...
var TaskDefinition_BazelRequest_DEFAULT BazelExecuteRequest

func (p *TaskDefinition) GetBazelRequest() BazelExecuteRequest {
...
func (p *TaskDefinition) readField3(iprot thrift.TProtocol) error {
	p.BazelRequest = &BazelExecuteRequest{}
...
func (p *BazelAction) readField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.OutputFiles = append(p.OutputFiles, _elem4)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *BazelAction) readField4(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.OutputDirs = append(p.OutputDirs, _elem5)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *BazelAction) readField5(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		_elem6 := &BazelProperty{}
		if err := _elem6.Read(iprot); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem6), err)
		}
		p.PlatformProperties = append(p.PlatformProperties, _elem6)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
