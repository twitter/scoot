...
type Command struct {
	...
	SnapshotId string            `thrift:"snapshotId,4,required" db:"snapshotId" json:"snapshotId"`
}
...
type TaskDefinition struct {
	...
	TaskId       *string               `thrift:"taskId,2" db:"taskId" json:"taskId,omitempty"`
	BazelRequest *bazel.ExecuteRequest `thrift:"bazelRequest,3" db:"bazelRequest" json:"bazelRequest,omitempty"`
}
...
type JobDefinition struct {
	JobType   *string           `thrift:"jobType,1" db:"jobType" json:"jobType,omitempty"`
	Tasks     []*TaskDefinition `thrift:"tasks,2" db:"tasks" json:"tasks,omitempty"`
	Priority  *int32            `thrift:"priority,3" db:"priority" json:"priority,omitempty"`
	Tag       *string           `thrift:"tag,4" db:"tag" json:"tag,omitempty"`
	Basis     *string           `thrift:"basis,5" db:"basis" json:"basis,omitempty"`
	Requestor *string           `thrift:"requestor,6" db:"requestor" json:"requestor,omitempty"`
}
...
type Job struct {
	...
	JobDefinition *JobDefinition `thrift:"jobDefinition,2,required" db:"jobDefinition" json:"jobDefinition"`
}
