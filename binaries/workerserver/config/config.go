...
func configDs_store() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/.DS_Store", size: 6148, mode: os.FileMode(420), modTime: time.Unix(1493128738, 0)}
...
func configConfigGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/config.go", size: 0, mode: os.FileMode(420), modTime: time.Unix(1495476606, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
