...
func configLocalMemory() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/local.memory", size: 312, mode: os.FileMode(420), modTime: time.Unix(1490915765, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
