...
func configConfigGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/config.go", size: 0, mode: os.FileMode(420), modTime: time.Unix(1520465144, 0)}
...
func configLocalLocal() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/local.local", size: 367, mode: os.FileMode(420), modTime: time.Unix(1520461669, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func configLocalMemory() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/local.memory", size: 277, mode: os.FileMode(420), modTime: time.Unix(1520461669, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
